...
df = spark.read.option("multiline","true").json("s3a://projet-fil-rouge-s3-dev/raw-data/olivier/departure=CDG/arrival=NSI/date=18-11-2025/time=21-53/flight_data.json")
